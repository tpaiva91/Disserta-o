...
\title{Melhorias no controlo da glicemia através de \textit{data mining}}
...
\dedicationpage{Dedicado aos meus pais.}
...
\include{chap-intro}
\include{chap-fundamentos}
\include{chap-related}
\include{chap-architecture}
\include{chap-development} 
